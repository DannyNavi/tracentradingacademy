...
export const DEFAULT_SPACES: BoardSpace[] = [
  ...
  { id: 2, kind: 'community', name: 'Support Event' },
  ...
  { id: 10, kind: 'jail', name: 'Infirmary' },
  ...
  { id: 17, kind: 'community', name: 'Support Event' },
  ...
  { id: 33, kind: 'community', name: 'Support Event' },
...
export const DEFAULT_CHANCE: GameCard[] = [
  ...
  { id: 'ch8', text: 'Get out of Infirmary free. Keep until needed.', effect: { type: 'get_out_of_jail' } },
...
export const DEFAULT_COMMUNITY: GameCard[] = [
  ...
  { id: 'cm6', text: 'Beauty sleep in the Infirmary.', effect: { type: 'jail' } },
  { id: 'cm7', text: 'Get out of Infirmary free.', effect: { type: 'get_out_of_jail' } },
